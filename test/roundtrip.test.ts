...
test('parses the worked example from format-spec.md into the expected shape', () => {
  ...
  assert.deepEqual(lead.notes[0], { id: 'n100000', pitch: 64, start: 0, duration: 2, velocity: 0.8, chance: 100, cent: 0, ratchetCount: 1, ratchetCurve: 0, ratchetLength: 1, active: true })
})
    ...
    tracks: [
      {
        ...
        clips: [],
        notes: [
          { id: 'u1', pitch: 33, start: 0, duration: 2, velocity: 0.8, chance: 100, cent: 0, ratchetCount: 1, ratchetCurve: 0, ratchetLength: 1, active: true },
          { id: 'u2', pitch: 33, start: 4, duration: 2, velocity: 0.8, chance: 100, cent: 0, ratchetCount: 1, ratchetCurve: 0, ratchetLength: 1, active: true },
        ],
        hits: [],
