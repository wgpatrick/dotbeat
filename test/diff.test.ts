...
test('setValue note-add grammar mints the same note addNote would, byte-for-byte', () => {
  ...
  assert.deepEqual(added, { id: added.id, pitch: 76, start: 12, duration: 2, velocity: 0.9, chance: 100, cent: 0, ratchetCount: 1, ratchetCurve: 0, ratchetLength: 1, active: true })
})
