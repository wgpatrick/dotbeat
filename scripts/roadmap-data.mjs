...
export const rows = [
  ...
  },
  {
    ...
    description: 'Close the engine\'s self-inflicted eval gap: every engine clip ever blind-rated used generateSeedBeat\'s RANDOM patches while surge got 639 designed presets curated to top-quartile — and the one D27 win so far came from a random patch (produced, commercial figure). E0 patch provenance in manifests; E1 factory.json presets into the showdown engine arm (role-mapped, seeded, exclude-chained); E2 curated engine bank (port curate-surge-patches.mjs over factory + ~2k screened random rolls + match-derived patches -> presets/engine-curated.json, consumed by showdown/seeds/gen-kit/pilot); E3 T6-as-preset-factory (beat match best.beat harvested over ref pools); E4 critic-targeted CMA-ES patch search, gated on E2\'s blind result. Full plan: docs/engine-presets.md.',
    core: 'missing', cli: 'missing', gui: 'na', status: 'not-started',
