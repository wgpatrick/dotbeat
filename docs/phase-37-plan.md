...
| RE | Research 145 (filed as 103; renumbered 2026-07-26): generative-audio APIs (no code) | no | `docs/research/146-generative-audio-apis.md` |
...
`docs/research/146-generative-audio-apis.md`, house research format (claims + sources + confidence
