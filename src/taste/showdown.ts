...
// applyComposedPhrase / inferSeedKey moved to src/compose/apply.ts on 2026-07-27: `beat compose`
// (and beat_compose, in src/mcp) need them, and the DAW may not import the taste program
// (D8 / research/136 §4). Neither ranks anything — they are document vocabulary that happened to
// be filed here. Re-exported so every existing caller, including cli/beat.mjs's dynamic
// `showdown.applyComposedPhrase` / `showdown.inferSeedKey`, is unchanged.
export { applyComposedPhrase, inferSeedKey } from '../compose/apply.js'
import { applyComposedPhrase, inferSeedKey } from '../compose/apply.js'
