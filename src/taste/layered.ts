...
/** The layered gate's feature view of a render: the existing 13-feature vector, plus centroid in Hz
 * rather than log2 (which is what every target row is quoted in), plus the articulation family from
 * src/taste/articulation.ts.
 *
